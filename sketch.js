...
function setup() {
  ...
  b1 = createSprite(width - 150 ,10, 30, 30);
  b1.addImage(b1img);
  b1.visible = false;
  b1.class = "plimg1";

  b2 = createSprite(width - 150 ,10, 30, 30);
  b2.addImage(b2img);
  b2.visible = false;

  b3 = createSprite(width - 150 ,10, 30, 30);
  b3.addImage(b3img);
  b3.visible = false;

  b4 = createSprite(width - 150 ,10, 30, 30);
  b4.addImage(b4img);
  b4.visible = false;

  b5 = createSprite(width - 150 ,10, 30, 30);
  b5.addImage(b5img);
  b5.visible = false;

  b6 = createSprite(width - 150 ,10, 30, 30);
  b6.addImage(b6img);
  b6.visible = false;

  b7 = createSprite(width - 150 ,10, 30, 30);
  b7.addImage(b7img);
  b7.visible = false;

  b8 = createSprite(width - 150 ,10, 30, 30);
  b8.addImage(b8img);
  b8.visible = false;

  b9 = createSprite(width - 150 ,10, 30, 30);
  b9.addImage(b9img);
  b9.visible = false;

  b10 = createSprite(width - 150 ,10, 30, 30);
  b10.addImage(b10img);
  b10.visible = false;

  b11 = createSprite(width - 150 ,10);
  b11.addImage(b11img);
  b11.visible = false;

  gc1 = createSprite(width - 350, 10, 30, 30);
  gc1.addImage(gc1img);
  gc1.visible = false;

  gc2 = createSprite(width - 350, 10, 30, 30);
  gc2.addImage(gc2img);
  gc2.visible = false;

  gc3 = createSprite(width - 350, 10, 30, 30);
  gc3.addImage(gc3img);
  gc3.visible = false;

  gc4 = createSprite(width - 350, 10, 30, 30);
  gc4.addImage(gc4img);
  gc4.visible = false;

  gc5 = createSprite(width - 350, 10, 30, 30);
  gc5.addImage(gc5img);
  gc5.visible = false;
...
function level1clues() {
  ...
  if (frameCount % 320 == 0) {
    dr = createSprite(width,height-100);
    dr.class = "plimg1";
    dr.scale = 0.2;
    dr.velocityX = -2;
